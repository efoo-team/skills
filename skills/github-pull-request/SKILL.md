...
| ケース | 確認内容 | 画像 |
| --- | --- | --- |
| URL誤入力 | `LIFF URLではなく、LIFF IDを入力してください。` が表示 | ![01-url-error.png](https://github.com/user-attachments/assets/...) |
| 正常保存 | 保存成功後に期待した表示へ遷移する | ![03-success.png](https://github.com/user-attachments/assets/...) |
